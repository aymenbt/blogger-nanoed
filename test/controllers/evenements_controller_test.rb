...
class EvenementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evenement" do
    assert_difference('Evenement.count') do
      post evenements_url, params: { evenement: { description: @evenement.description, name: @evenement.name, start_time: @evenement.start_time } }
    end
  ...
  test "should update evenement" do
    patch evenement_url(@evenement), params: { evenement: { description: @evenement.description, name: @evenement.name, start_time: @evenement.start_time } }
